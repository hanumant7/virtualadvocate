...
export default function Result() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#8F87F1] to-[#C68EFD]">
      ...
      {/* Profile Modal (Optional future expansion) */}
      {showProfile && (
                  ...
                  {judgments.map((j, index) => (
                    <li key={index}>
                      <a
                        ...
                        className="block p-3 rounded-lg border hover:bg-blue-50 transition text-blue-700 font-medium"
                      >
                        {j.title}
                      </a>
                    </li>
...
function Section({ icon, title, children }) {
  return (
    <div className="border-l-4 border-[#8F87F1] pl-4 space-y-3">
